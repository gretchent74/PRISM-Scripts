...
BeginDialog UnUn1_Dialog, 0, 0, 276, 135, "Unreimbursed Uninsured Docs Received"
  ...
  CheckBox 140, 80, 25, 10, "NCP", NCP_checkbox
  ...
  Text 45, 65, 190, 10, "Check who returned the Unreimbursed/Uninsured forms."
  Text 125, 80, 15, 10, "or"
EndDialog
'end first dialog 
...
Do
	...
	Dialog UnUn1_Dialog 'Shows name of dialog
		...
		IF CP_checkbox = 1 AND NCP_checkbox = 1 THEN err_msg = err_msg & vbNewline & "Please select either CP or NCP."
		IF CP_checkbox = 0 AND NCP_checkbox = 0 THEN err_msg = err_msg & vbNewline & "Please select either CP or NCP."
		IF err_msg <> "" THEN 
...
DIM Ncp_requested_Dialog, NCPCAAD_checkbox, cpod_checkbox, cp_documents_checkbox
Do
	err_msg = ""
