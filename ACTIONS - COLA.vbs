'COLA SCRIPT--this script is like a default flow for cola with reminders on what to look for, it may not work for all counties
...
'END OF copy and paste from functions library ended------------------------------------------------------------------------
...
DIM MN_order, correct, special_arrears, initials, COLACAAD, FINALResult
...
Do	
	...
	Dialog COLACAAD				'Shows name of dialog
		...
		IF Initials = "" THEN MsgBox "Please sign your CAAD Note."
		IF err_msg <> "" THEN 
...
'this will add information to the CAAD note
	...
	CALL write_variable_in_CAAD(Initials)
	'transmit
	'PF3
