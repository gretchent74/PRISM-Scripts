...
'DIALOG 1-------------------------------------------------------------------------
DIM PICK_Dialog, IW_CALC, IW_Notice

BeginDialog PICK_Dialog, 0, 0, 141, 80, "Dialog"
  CheckBox 25, 20, 115, 10, "IW CALCULATOR message box.", IW_CALC
  CheckBox 25, 40, 85, 10, " IW Notice CAAD note.", IW_Notice
  ButtonGroup ButtonPressed
    OkButton 15, 60, 50, 15
    CancelButton 80, 60, 50, 15
  Text 5, 5, 115, 10, "Please check ONE of the following:"
EndDialog
...
Do
	...
	err_msg = ""	
	Dialog PICK_Dialog	'shows name of dialog		
		IF buttonpressed = 0 then stopscript		'Cancel
		IF IW_CALC = 0 AND IW_Notice = 0 THEN err_msg = vbNewline & "Either IW Calculator or IW Notice MUST be checked."
		IF err_msg <> "" THEN 
